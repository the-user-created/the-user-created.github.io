	...
	const projects = {
		...
		yoda: {
			...
			tech: [
				...
				{ icon: 'devicon-dot-net-plain-wordmark', name: 'OpenCL' },
				{ icon: 'fas fa-microchip', name: 'Verilog' },
		...
		stm_data_sharc: {
			...
			tech: [
				...
				{ icon: 'fas fa-microchip', name: 'STM32 MCU' },
				{ icon: 'fas fa-satellite-dish', name: 'Iridium Comms' }
			],
