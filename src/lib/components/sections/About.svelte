...
<div class="content-wrapper">
	<h1 class="mb-0">
		...
		<span class="text-primary glitch" data-text="YOUNG">YOUNG</span>
	</h1>
	<div class="subheading mb-5">
		<span class="glitch" data-text="Operating out of: Cape Town Grid, SA">
			Operating out of: Cape Town Grid, SA
		</span>
	</div>
	<p class="lead mb-5">
	...
	<p class="lead mb-5">
		Basically, I’m always learning, always upgrading, and always ready to jack into a new challenge. Let's build
		something nova.
	</p>
